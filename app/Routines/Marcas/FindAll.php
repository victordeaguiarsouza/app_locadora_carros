...
class FindAll extends FindAllBase
{
    ...
    public function execute(Request $request){
        ...
        return parent::find(new Marca, $request);
    }
    ...
    protected function buildFind($request){
        ...
        if($request->has('atributos_modelo')){
            $this->selectAtributosRegistrosRelacionados('modelos:id,' . $request->atributos_modelo);
        }else{
            $this->selectAtributosRegistrosRelacionados('modelos');
        }
